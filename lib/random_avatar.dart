...
String RandomAvatarString(String string, {bool trBackground = false}) {
  ...
  Map<String, Map<String, String>> sP = {
    '00': {},
    '01': {},
    '02': {},
    '03': {},
  ...
  sP['14']?['eyes'] =
      '<path d="m133 108.17h14.17m-63.26 0h14.09m-20.69-8.93a21.31 21.31 0 0 1 27.29 0m21.8 0a21.31 21.31 0 0 1 27.29 0" style="fill:none;' +
          str +
          '4.8243px;stroke:#000;"/>';
  sP['14']?['top'] = '<path d="m115.5 51.75c-38.702 5.3101-54.215 18.038-59.863 35.101" style="fill:none;' +
      str +
